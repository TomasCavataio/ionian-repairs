...
const el = {
  ...
  services: [
    { title: 'Ανακαινίσεις κατοικιών', text: 'Ολοκληρωμένες ή μερικές ανακαινίσεις με σωστό σχεδιασμό, προσεγμένες λεπτομέρειες και λειτουργικά αποτελέσματα.' },
    { title: 'Επισκευές και συντήρηση', text: 'Μικρές και μεγάλες τεχνικές εργασίες για κατοικίες, εξοχικά και επαγγελματικούς χώρους.' },
    { title: 'Ελαιοχρωματισμοί', text: 'Εσωτερικοί και εξωτερικοί χρωματισμοί με σωστή προετοιμασία επιφανειών και καθαρό τελείωμα.' },
    { title: 'Υδραυλικές εργασίες', text: 'Επισκευές, αντικαταστάσεις και νέες εγκαταστάσεις για μπάνια, κουζίνες και εξωτερικούς χώρους.' },
    { title: 'Μονώσεις και στεγανοποιήσεις', text: 'Προστασία από υγρασία, βροχή και φθορές με λύσεις κατάλληλες για το κλίμα του νησιού.' },
    { title: 'Εργασίες εξωτερικών χώρων', text: 'Επισκευές σε αυλές, βεράντες, τοίχους, σκάλες και περιβάλλοντες χώρους.' },
  ],
  ...
  projects: [
    { category: 'Ανακαινίσεις', title: 'Κατοικία με φυσικά υλικά', meta: 'Ενδεικτική παρουσίαση', image: 'hero' },
    { category: 'Εσωτερικοί χώροι', title: 'Μπάνιο με χειροποίητες υφές', meta: 'Ενδεικτική παρουσίαση', image: 'bathroom' },
    { category: 'Εξωτερικοί χώροι', title: 'Αυλή και πέτρινες επιφάνειες', meta: 'Ενδεικτική παρουσίαση', image: 'hero' },
  ],
  projectDemo: 'Προσωρινό οπτικό υλικό — όχι πραγματικό έργο',
  projectAlt: 'Ενδεικτικό οπτικό ανακαίνισης για μελλοντική αντικατάσταση με πραγματικό έργο',
  ...
  contact: {
    ...
    services: ['Ανακαίνιση', 'Επισκευή', 'Βάψιμο', 'Υδραυλικά', 'Μόνωση', 'Εξωτερικός χώρος', 'Άλλο'],
    ...
    success: 'Το αίτημά σας καταχωρήθηκε στη δοκιμαστική φόρμα. Η πραγματική αποστολή θα ενεργοποιηθεί μόλις συνδεθεί ο πάροχος.',
    error: 'Δεν ήταν δυνατή η αποστολή. Δοκιμάστε ξανά ή επικοινωνήστε μαζί μας.',
    integration: 'Η φόρμα είναι έτοιμη για σύνδεση· μέχρι να οριστεί πάροχος, δεν αποστέλλει προσωπικά δεδομένα.',
  ...
  privacy: {
    ...
    sections: [
      { title: 'Υπεύθυνος επεξεργασίας', text: '[ΝΟΜΙΚΗ ΕΠΩΝΥΜΙΑ], [ΔΙΕΥΘΥΝΣΗ], [ΑΦΜ], [EMAIL], [ΤΗΛΕΦΩΝΟ].' },
      ...
      { title: 'Πάροχος φόρμας', text: '[ΠΑΡΟΧΟΣ ΦΟΡΜΑΣ — ΝΑ ΣΥΜΠΛΗΡΩΘΕΙ]. Δεν χρησιμοποιούνται μη απαραίτητα cookies σε αυτή την έκδοση.' },
...
const en: Widen<typeof el> = {
  ...
  services: [
    { title: 'Home renovations', text: 'Complete or partial renovations with thoughtful planning, careful detailing and practical results.' },
    { title: 'Repairs and maintenance', text: 'Small and large-scale technical work for homes, holiday properties and commercial spaces.' },
    { title: 'Painting and decorating', text: 'Interior and exterior painting with thorough surface preparation and a clean finish.' },
    { title: 'Plumbing work', text: 'Repairs, replacements and new installations for bathrooms, kitchens and outdoor areas.' },
    { title: 'Insulation and waterproofing', text: 'Protection from damp, rain and deterioration with solutions suited to the island climate.' },
    { title: 'Outdoor works', text: 'Repairs to courtyards, terraces, walls, stairs and surrounding areas.' },
  ],
  ...
  projects: [
    { category: 'Renovations', title: 'Home with natural materials', meta: 'Illustrative presentation', image: 'hero' },
    { category: 'Interiors', title: 'Bathroom with handcrafted texture', meta: 'Illustrative presentation', image: 'bathroom' },
    { category: 'Exteriors', title: 'Courtyard and stone surfaces', meta: 'Illustrative presentation', image: 'hero' },
  ],
  projectDemo: 'Temporary visual — not a completed client project',
  projectAlt: 'Illustrative renovation visual to be replaced with real project photography',
  ...
  contact: {
    ...
    placeholders: {
      name: 'Your name', phone: '+30 …', email: 'name@example.com', location: 'e.g. Lixouri',
      details: 'Briefly describe the property and the work…', select: 'Select',
    },
    services: ['Renovation', 'Repair', 'Painting', 'Plumbing', 'Insulation', 'Outdoor work', 'Other'],
    ...
    success: 'Your enquiry was recorded in the demonstration form. Delivery will be enabled once a form provider is connected.',
    error: 'The request could not be sent. Please try again or contact us directly.',
    integration: 'The form is ready to connect; until a provider is configured, it does not send personal data.',
  ...
  privacy: {
    ...
    sections: [
      { title: 'Data controller', text: '[LEGAL COMPANY NAME], [ADDRESS], [TAX NUMBER], [EMAIL], [PHONE].' },
      ...
      { title: 'Form provider', text: '[FORM PROVIDER — TO BE COMPLETED]. No non-essential cookies are used in this version.' },
