...
const el = {
  ...
  sections: {
    ...
    processKicker: '04 · Τρόπος εργασίας',
...
const en: Widen<typeof el> = {
  ...
  sections: {
    ...
    processKicker: '04 · How we work', processTitle: 'From the first conversation to completion',
    ...
    areasKicker: '02 · Service areas', areasTitle: 'Based in Lixouri, working across Kefalonia',
